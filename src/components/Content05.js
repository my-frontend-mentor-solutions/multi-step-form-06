...
export default function Content05() {
    ...
    return (
        <div className='flex flex-col items-center justify-center mt-10'>
            ...
            <Link type="button" className=' text-extra-light-gray bg-marine-blue px-[18px] py-[10px] rounded-lg hover:bg-marine-light-blue duration-200 mt-8' to={"/"} >Return To Main Menu</Link>
        </div>
    )
}
